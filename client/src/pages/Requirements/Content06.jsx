  ...
  return (
    <div className="RequirementsBodyContents">
      ...
      <div className="RequirementsBodyDesc">
        ...
        />
        <label htmlFor="supportProjectTrue">
          네, 정부지원사업 또는 연구과제입니다.
        </label>
        <input
          type="radio"
        ...
        />
        <label htmlFor="supportProjectFalse">아닙니다</label>
      </div>
      <div className="RequirementsBodyDesc">
        <h3>지원자 필수 요건</h3>
        ...
        <div>
          ...
          />
          <label htmlFor="applicantRequirements01">개인 또는 팀 가능</label>
        </div>
        <div>
          <input
            type="checkbox"
          ...
          />
          <label htmlFor="applicantRequirements02">
            사업자 가능 (세금계산서 발행)
          </label>
        </div>
        <div>
          ...
          />
          <label htmlFor="applicantRequirements03">
            업력 1년 이상 (사업자등록증 기준)
          </label>
        </div>
        <div>
          ...
          />
          <label htmlFor="applicantRequirements04">보증보험 발급 가능</label>
        </div>
        <div>
          <input
            type="checkbox"
      ...
      <div className="RequirementsBodyDesc">
        ...
        <p>
          ...
          <br />
          클라이언트님이 파트너를 선정할 때 지원서와 함께 답변 내용을 검토할 수
          있습니다.
        </p>
        <textarea
          type="text"
